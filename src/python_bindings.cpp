...
PYBIND11_MODULE(SCE, m) {
  ...
  m.def("wtsne", &wtsne, py::return_value_policy::take_ownership,
        ...
        py::arg("P_vec"), py::arg("weights"), py::arg("maxIter"),
        py::arg("nRepuSamp") = 5, py::arg("eta0") = 1, py::arg("bInit") = 0,
        py::arg("n_threads") = 1, py::arg("seed") = 1);

#ifdef GPU_AVAILABLE
  m.def("wtsne_gpu", &wtsne_gpu<double>, py::return_value_policy::take_ownership,
        "Run stochastic cluster embedding with CUDA", py::arg("I_vec"),
        py::arg("J_vec"), py::arg("P_vec"), py::arg("weights"), py::arg("maxIter"),
        py::arg("blockSize") = 128, py::arg("blockCount") = 128,
        py::arg("nRepuSamp") = 5, py::arg("eta0") = 1, py::arg("bInit") = 0,
        py::arg("n_threads") = 1, py::arg("seed") = 1);
